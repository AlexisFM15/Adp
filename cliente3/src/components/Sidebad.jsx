...
import { FaTachometerAlt, FaRegSun, FaWrench, FaStickyNote, FaRegChartBar, FaRegCalendarAlt, FaChevronRight, FaChevronLeft } from "react-icons/fa"

const Sidebar = () => {
    return (
        <div className='bg-zinc-700 px-[25px] h-screen rounded-lg'>

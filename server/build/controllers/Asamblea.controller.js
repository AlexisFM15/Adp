...
const createAsamblea = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield database_1.pool.query("INSERT INTO Asamblea (usuario, fechaProgramada, direccion, NumeroConvocatoria, tipoAsamblea, directivaConvocante,estatusAsamblea, fecha_registro) VALUES (?,?,?,?,?,?,?,?)", [
            usuario,
            fechaProgramada,
            direccion,
            NumeroConvocatoria,
        ...
        const [asambleafound] = yield database_1.pool.query("SELECT * FROM Usuario WHERE email = ?", [NumeroConvocatoria]);

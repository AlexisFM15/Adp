...
const createusuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield database_1.pool.query("INSERT INTO Usuario (nombre, apellido, email, contrasena, nivel, fecha_registro) VALUES (?,?,?,?,?, fecha_registro)", [nombre, apellido, email, contrasena, nivel, fecha_registro]);
...
const deleteusuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [rows] = yield database_1.pool.query("DELETE FROM Usuario WHERE id_user = ?", [
            req.params.id,
        ]);
        res.json(rows);
    }
